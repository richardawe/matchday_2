...
Route::middleware('guest')->group(function () {
    ...
    Route::post('reset-password', [NewPasswordController::class, 'store'])
        ...
        // JavaScript OAuth Callback Routes
        Route::post('auth/google/callback', [SocialAuthController::class, 'handleGoogleCallback'])
            ->name('auth.google.callback');
        
        // Google OAuth Redirect Route (fallback)
        Route::get('auth/google/callback', [SocialAuthController::class, 'handleGoogleRedirect'])
            ->name('auth.google.redirect');
        
        // Alternative Google OAuth Redirect Route
        Route::get('auth/google/redirect', [SocialAuthController::class, 'handleGoogleRedirect'])
            ->name('auth.google.redirect.alt');
